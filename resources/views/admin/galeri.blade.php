...
@if(session('success'))
    <div style="background: #E8F5E9; color: #2E7D32; padding: 16px; border-radius: 12px; margin-bottom: 24px; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600;">
        {{ session('success') }}
    </div>
@endif

@if ($errors->any())
    <div style="background: #FFEBEE; color: #BA1A1A; padding: 16px; border-radius: 12px; margin-bottom: 24px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 14px;">
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-container">
        <div class="modal-header">
            <h3 class="modal-title" style="color:#BA1A1A;">Hapus Foto</h3>
            <button class="close-btn" onclick="closeModal('deleteModal')"><span class="material-symbols-outlined">close</span></button>
        </div>
        <p style="font-family:'Plus Jakarta Sans'; color:#404945;">Apakah Anda yakin ingin menghapus foto ini dari galeri? Aksi ini tidak dapat dibatalkan.</p>
