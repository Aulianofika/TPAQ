...
@push('styles')
    <style>
        ...
        .stat-icon-wrapper.santri {
            background: #10B981;
            color: #FFFFFF;
            box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);
        }

        .stat-icon-wrapper.aktif {
            background: #F59E0B;
            color: #FFFFFF;
            box-shadow: 0 4px 12px rgba(245, 158, 11, 0.3);
        }

        .stat-icon-wrapper.ikhwan {
            background: #3B82F6;
            color: #FFFFFF;
            box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3);
        }

        .stat-icon-wrapper.akhwat {
            background: #EC4899;
            color: #FFFFFF;
...
@section('content')
    <div class="content-canvas">
        ...
        @if(session('success'))
            <div
                style="background-color: #D1FAE5; border: 1px solid #10B981; color: #065F46; padding: 16px 24px; border-radius: 16px; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; display: inline-flex; width: fit-content; align-items: center; gap: 8px;">
            ...
            <div class="table-header-bar">
                ...
                <form method="GET" action="{{ route('admin.santri.index') }}" class="search-filter-form" id="filterForm">
                    <div class="search-input-wrapper">
                        ...
                        <input type="text" id="searchInput" placeholder="Cari santri..." autocomplete="off"
                            class="input-search">
                    </div>
                    ...
                    <tbody>
                        @forelse($students as $student)
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-data">{{ $student->kelas->nama_kelas ?? '-' }}</p>
                                </td>
                                <td>
                                    <p class="text-data">{{ $student->nama_wali }}</p>
                                </td>
                                <td>
                                    <p class="text-data-muted">{{ $student->no_hp_wali }}</p>
                                </td>
                                <td>
                                ...
                                <td class="actions-cell" style="padding-right: 32px;">
                                    ...
                                    @endphp
                                    <a href="{{ route('admin.santri.progress.show', $student->id_santri) }}" class="action-btn"
                                        title="Detail Progress" style="text-decoration: none;">
                        ...
                        @empty
                            <tr>
                                <td colspan="7"
                                    style="text-align: center; color: #78716C; padding: 48px; font-family: 'Plus Jakarta Sans', sans-serif;">
    ...
    <div id="deleteModal"
        ...
        <div
            style="background: white; border-radius: 24px; padding: 32px; width: 90%; max-width: 400px; position: relative; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);">
            <button type="button" onclick="closeDeleteModal()"
                style="position: absolute; right: 24px; top: 24px; background: none; border: none; cursor: pointer; color: #64748B; padding: 4px; display: flex; align-items: center; justify-content: center; border-radius: 50%; transition: background 0.2s;"
                onmouseover="this.style.background='#F1F5F9'" onmouseout="this.style.background='none'">
                <span class="material-symbols-outlined" style="font-size: 20px;">close</span>
            </button>

            <h3
                style="font-family: 'Epilogue', sans-serif; font-weight: 700; font-size: 20px; color: #003227; margin: 0 0 16px 0;">
                Hapus Data Santri</h3>

            <p
                style="font-family: 'Plus Jakarta Sans', sans-serif; font-size: 14px; color: #64748B; margin: 0 0 32px 0; line-height: 1.6;">
                Apakah Anda yakin ingin menghapus data santri ini? Tindakan ini bersifat permanen dan tidak dapat
                dibatalkan.
            </p>

            <div style="display: flex; gap: 12px; justify-content: center;">
                <button type="button" onclick="closeDeleteModal()"
                    style="flex: 1; padding: 12px 24px; border-radius: 32px; border: 1px solid #E2E8F0; background: white; color: #475569; font-weight: 600; cursor: pointer; font-family: 'Plus Jakarta Sans', sans-serif; transition: background 0.2s;"
                    onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background='white'">Batal</button>
                <form id="deleteForm" method="POST" style="margin: 0; flex: 1; display: flex;">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                        style="width: 100%; padding: 12px 24px; border-radius: 32px; border: none; background: #DC2626; color: white; font-weight: 600; cursor: pointer; font-family: 'Plus Jakarta Sans', sans-serif; transition: background 0.2s;"
                        onmouseover="this.style.background='#B91C1C'" onmouseout="this.style.background='#DC2626'">Hapus
                        Data</button>
                </form>
            </div>
        </div>
