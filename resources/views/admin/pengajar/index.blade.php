...
@section('content')
    <div class="content-canvas">
        ...
        <div class="modal-overlay" id="deleteModal">
            <div class="modal-container">
                <div class="modal-header">
                    <h3 class="modal-title" style="color:#BA1A1A;">Hapus Data</h3>
                    <button class="close-btn" onclick="closeModal('deleteModal')"><span
                            class="material-symbols-outlined">close</span></button>
                </div>
                <p style="font-family:'Plus Jakarta Sans'; color:#404945;">Apakah Anda yakin ingin menghapus anggota ini?
                    Seluruh data yang terkait mungkin akan ikut terpengaruh.</p>
