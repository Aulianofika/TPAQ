...
@section('content')
    <div class="content-canvas">
        ...
        @if(session('success'))
            <div
                style="background-color: #ECFDF5; border: 1px solid #10B981; color: #047857; padding: 16px 24px; border-radius: 9999px; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; display: inline-flex; width: fit-content; align-items: center; gap: 8px;">
        ...
        @if(session('error'))
            <div
                style="background-color: #FEF2F2; border: 1px solid #EF4444; color: #991B1B; padding: 16px 24px; border-radius: 9999px; font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; display: inline-flex; width: fit-content; align-items: center; gap: 8px;">
                                ...
                                <td style="padding-right: 32px;">
                                    <div class="actions-cell">
                                        <button class="action-btn"
                                            onclick="openEditModal('{{ $k->id_kelas }}', '{{ addslashes($k->nama_kelas) }}', '{{ $k->id_pengajar }}')"
                                            title="Edit Kelas">
                                            <span class="material-symbols-outlined" style="font-size: 18px;">edit</span>
                                        </button>
                                        <button type="button" class="action-btn btn-delete"
                                            onclick="openDeleteModal(`{{ route('admin.kelas.destroy', $k->id_kelas) }}`)"
                                            title="Hapus Kelas">
                            ...
                            <tr>
                                <td colspan="5" style="text-align: center; padding: 48px; color: #A8A29E;">
                                    <span class="material-symbols-outlined"
                                        style="font-size: 48px; margin-bottom: 16px; opacity: 0.5;">class</span>
                                    <p style="font-family: 'Plus Jakarta Sans', sans-serif; margin: 0;">Belum ada data kelas.
                                    </p>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div class="modal-container">
            ...
            <form action="{{ route('admin.kelas.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_kelas" class="form-control" placeholder="Contoh: Kelas Abu Bakar"
                        required>
                </div>
                <div class="form-group">
